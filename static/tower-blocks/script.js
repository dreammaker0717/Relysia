  ...
  place() {
    ...
    axios.post('/post', {
      notes: [
        ...
        'demo',
        'block',
        btoa(`Overlap: ${overlap}, Score: ${score}`),
      ],
    })
    let blocksToReturn = {
...
class Game {
  ...
  startGame() {
    if (this.state != this.STATES.PLAYING) {
      this.scoreContainer.innerHTML = '0'
      // this.levelContainer.innerHTML = 'LEVEL : 1';
  ...
  placeBlock() {
    console.log('Block Placed by player')
    ...
    this.addBlock()
    if ((this.blocks.length - 2) % 5 === 0) this.handlerFunc()
  }
  addBlock() {
  ...
  handlerFunc() {
    ...
    // this.levelContainer.innerHTML = `LEVEL : ${this.level}`;
    console.log('Called After each 5 blocks')
  }
...
function startTheGame(ev) {
  var docs = document.getElementById('gameStarterTower')
  console.log('starting')
  if (docs && docs.value === '2') {
    document.getElementById('gameStarterTower').value = '3'
