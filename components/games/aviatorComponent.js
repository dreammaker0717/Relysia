...
// import './aviator/js/game.js'
// import '../../pages/game/aviator/js/three.min.js'
// import '../../pages/game/aviator/js/TweenMax.min.js'
// import './aviator/css/demo.css'
// import './aviator/css/game.css'
// import './aviator/css/index.css'

function AviatorComponent(props) {
  ...
  React.useEffect(() => {
    ...
    function resetGame() {
      game = {
        ...
        giftCoinsSpeed: 0.8,
        giftCoinLastSpawn: 0,
        distanceForGiftCoinSpawn: Math.floor(
          Math.random() * (18000 - 3600) + 3600,
        ),
  ...
  return (
    ...
    user-scalable=0"
        ...
        ></script>
        {/* <script type="text/javascript" src="/static/aviator/js/game.js"></script> */}
      </Head>
