...
const infrastructureImage = require('../../../assets/images/home-page/hero/infrastructureNew.svg')
    ...
    if (isTablet) {
      ...
      return (
        <>
          ...
          <Dots sides={{ top: isWallet ? '460px' : '563px', right: '320px' }} />
        </>
      )
    }
  }
    ...
    <div className={styles.base}>
      ...
      <div
        className={`${styles.img} ${
          !isWallet
            ? 'sm:translate-y-40 sm:scale-75 lg:translate-y-0 lg:scale-100'
            : ''
        }`}
      >
        {isWallet && (
